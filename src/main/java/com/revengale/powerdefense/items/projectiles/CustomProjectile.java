...
public abstract class CustomProjectile extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(CustomProjectile.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public CustomProjectile.PickupStatus canBePickedUp;
    ...
    public CustomProjectile(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.canBePickedUp = CustomProjectile.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
        this.setSize(0.5F, 0.5F);
    }

    public CustomProjectile(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public CustomProjectile(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.canBePickedUp = CustomProjectile.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void func_184549_a(RayTraceResult p_184549_1_)
    {
        ...
        if (entity != null)
        {
            ...
            {
                damagesource = DamageSource.generic;//DamageSource.causeArrowDamage(this, this.shootingEntity);
            }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        {
            this.canBePickedUp = CustomProjectile.PickupStatus.func_188795_a(tagCompund.getByte("pickup"));
        }
        else if (tagCompund.hasKey("player", 99))
        {
            this.canBePickedUp = tagCompund.getBoolean("player") ? CustomProjectile.PickupStatus.ALLOWED : CustomProjectile.PickupStatus.DISALLOWED;
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.canBePickedUp == CustomProjectile.PickupStatus.ALLOWED || this.canBePickedUp == CustomProjectile.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.canBePickedUp == CustomProjectile.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static CustomProjectile.PickupStatus func_188795_a(int p_188795_0_)
        {
